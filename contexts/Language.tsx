...
export const strings = {
  en: {
    ...
    guestCount:        'Will you be bringing a +1?',
    guestNames:        'Your +1\'s Full Name',
    plusOneYes:        'Yes, bringing a +1',
    plusOneNo:         'Just me',
  ...
  hi: {
    ...
    guestCount:        'क्या आप अपने साथ किसी को ला रहे हैं?',
    guestNames:        '+1 का पूरा नाम',
    plusOneYes:        'हाँ, +1 के साथ',
    plusOneNo:         'सिर्फ मैं',
  ...
  gu: {
    ...
    eventDates:        '20 – 22 જાન્યુઆરી 2027',
    ...
    guestCount:        'શું તમે +1 સાથે આવો છો?',
    guestNames:        '+1 નું પૂરું નામ',
    plusOneYes:        'હા, +1 સાથે',
    plusOneNo:         'ફક્ત હું',
