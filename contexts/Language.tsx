  ...
  en: {
    ...
    chapters: {
      bloom: {
        ...
        outfitExamples: ['Pastel kurta sets or a floral jacket', 'Floral lehengas or sarees'],
      },
      promise: {
        event: 'Engagement & Cocktail', story: 'Two lives choose a shared forever.', shortLine: 'A toast to what’s ahead.',
        men: 'Tuxedos & Suits',
        women: 'Gowns only',
        outfitExamples: ['A tuxedo or tailored suit', 'An evening gown — no saree, lehenga or Indian separates for this one'],
      },
      romance: {
  ...
  hi: {
    ...
    chapters: {
      bloom: {
        ...
        outfitExamples: ['पेस्टल कुर्ता सेट या फूलों वाली जैकेट', 'फूलों वाली लहंगे या साड़ियां'],
      },
      promise: {
        event: 'सगाई और कॉकटेल', story: 'दो जिंदगियां एक साझा भविष्य चुनती हैं।', shortLine: 'आने वाले कल के नाम एक जाम।',
        men: 'टक्सीडो और सूट',
        women: 'केवल गाउन',
        outfitExamples: ['टक्सीडो या टेलर्ड सूट', 'एक इवनिंग गाउन — इस चैप्टर में साड़ी, लहंगा या इंडियन सेट नहीं'],
      },
      romance: {
  ...
  gu: {
    ...
    chapters: {
      bloom: {
        ...
        outfitExamples: ['પેસ્ટલ કુર્તા સેટ અથવા ફૂલોવાળી જેકેટ', 'ફૂલોવાળા લહેંગા અથવા સાડીઓ'],
      },
      promise: {
        event: 'સગાઈ અને કોકટેલ', story: 'બે જિંદગીઓ એક સહિયારું ભવિષ્ય પસંદ કરે છે.', shortLine: 'આગળના રસ્તા માટે એક ટોસ્ટ.',
        men: 'ટક્સિડો અને સૂટ',
        women: 'ફક્ત ગાઉન',
        outfitExamples: ['ટક્સિડો અથવા ટેલર્ડ સૂટ', 'એક ઇવનિંગ ગાઉન — આ પ્રકરણમાં સાડી, લહેંગા કે ઇન્ડિયન સેટ નહીં'],
      },
      romance: {
