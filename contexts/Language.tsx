...
export const strings = {
  en: {
    ...
    travelConfirmEyebrow: 'One More Thing',
    ...
    travelDetailsCta:  'One more thing — confirm your travel & stay →',
  },
  hi: {
    ...
    // Travel & ID confirmation
    travelConfirmEyebrow: 'एक और बात',
    ...
    travelDetailsCta:  'एक और बात — अपनी यात्रा और ठहरने की पुष्टि करें →',
  },
  gu: {
    ...
    // Travel & ID confirmation
    travelConfirmEyebrow: 'એક વધુ વાત',
    ...
    travelDetailsCta:  'એક વધુ વાત — તમારી મુસાફરી અને રોકાણની પુષ્ટિ કરો →',
  },
}
