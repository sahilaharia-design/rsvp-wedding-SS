...
export const strings = {
  en: {
    ...
    travelBody2:       'Once you reach Delhi, everything is on us — local transport to all events from the 20th through the 22nd, and a drop-off when you head back.',
  ...
  hi: {
    ...
    travelBody2:       'दिल्ली पहुँचने के बाद सब हमारी ज़िम्मेदारी — 20 से 22 जनवरी तक सभी कार्यक्रमों के लिए आना-जाना और वापसी तक।',
  ...
  gu: {
    ...
    travelBody2:       'દિલ્હી પહોંચ્યા પછી બધું અમારી જવાબદારી — ૨૦ થી ૨૨ જાન સુધી તમામ ઈવેન્ટ્સ માટે લોકલ ટ્રાન્સ્પોર્ટ અને પાછા જવા સુધી.',
